...
public class SkillWideAttack : AbstractSkill
{
    async UniTask SkillAttack()
    {
        var attackPosition = AttackPositions.GetAttackPosition(AttackDirection.ThreeHorizon, GameManager.Instance._player.transform);
